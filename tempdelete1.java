...
public class tempdelete1 extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req,HttpServletResponse res)
      throws ServletException,IOException {
        ...
        ss1="delete * from temployee where ecode="+a;
                
        st.executeUpdate(ss1);
pw.println("<html><body bgcolor=skyblue><br><br><br><br><br><br>");
        pw.println("<center><h2>Record Deleted</h2><br><br><a href='http://localhost:8080/servlet/tempemploy'>BACK</a></center>");
