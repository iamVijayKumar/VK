   ...
   public void init(ServletConfig sc) throws ServletException
  {
   ...
   public void doGet(HttpServletRequest req,HttpServletResponse res)
      throws ServletException,IOException {
         ...
         pw.println("<html><body bgcolor=skyblue><style>a{color:black}</style><center><h3>COMPANY DETAILS</h3><br><br>");
         ...
         pw.println("<br><br>");
         pw.println("<a href='http://localhost:8080/servlet/companye'>BACK</a></center>");
         if(temp==0)
