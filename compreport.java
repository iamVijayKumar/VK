...
import java.io.*;
import java.sql.*;
public class compreport extends HttpServlet {
   ...
   public void init(ServletConfig sc) throws ServletException
  {
   ...
   public void doGet(HttpServletRequest req,HttpServletResponse res)
      throws ServletException,IOException {
         ...
         pw.println("<html><body bgcolor=skyblue><center><h3>COMPANY REPORT</h3><br><br>");
         ...
         pw.println("</table>");
         pw.println("<br><br>");
         pw.println("<a href='http://localhost:8080/servlet/rectreport'>BACK</a></center></body></html>");
